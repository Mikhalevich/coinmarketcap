...
// Source: ./api/cryptocurrency/cryptocurrency.go
//
// Generated by this command:
//
//	mockgen -source=./api/cryptocurrency/cryptocurrency.go -destination=./api/cryptocurrency/cryptocurrency_mock.go -package=cryptocurrency
//
